...
namespace Tests.TwoVoiceVerticalShiftCouterpoint.IntervalInversionCalculation
{
    public class GivenANegativeJvIndex
    {
        ...
        [TestCase(-11, new[] { 0, 2, 4, 7 }, new[] { 1, 3 }, new[] { 5 }, new[] { 6 }, new int[0])]
        [TestCase(-7, new[] { 0, 2, 5, 7 }, new[] { 1, 6 }, new[] { 4 }, new[] { 3 }, new int[0])]
        [TestCase(-6, new[] { 2, 4 }, new[] { 3 }, new[] { 0, 5, 7 }, new[] { 1, 6 }, new[] { 2 })]
        [TestCase(-5, new[] { 0, 5, 7 }, new[] { 6 }, new[] { 2, 4 }, new[] { 1, 3 }, new[] { 5 })]
        [TestCase(-4, new[] { 0, 2, 4 }, new[] { 1, 3 }, new[] { 5, 7 }, new[] { 6 }, new int[0])]
        [TestCase(-3, new[] { 5, 7 }, new[] { 6 }, new[] { 0, 2, 4 }, new[] { 1, 3 }, new int[0])]
        [TestCase(-2, new[] { 0, 2, 4, 7 }, new[] { 1, 3 }, new[] { 5 }, new[] { 6 }, new[] { 2 })]
        [TestCase(-1, new[] { 5 }, new int[0], new[] { 0, 2, 4, 7 }, new[] { 1, 3, 6 }, new[] { 5 })]
